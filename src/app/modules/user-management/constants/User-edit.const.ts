...
export class UserEditConst {
  ...
  public static readonly arrPersonInfo = [
    {label: 'Họ và tên', value: UserFields.FULL_NAME, typeInput: "text", type: InputTypeEnum.INPUT },
    {label: 'Mật khẩu', value: UserFields.PASS_WORD, typeInput: "text", type: InputTypeEnum.INPUT },
    {label: 'Số điện thoại', value: UserFields.PHONE, typeInput: "text", type: InputTypeEnum.INPUT },
    {label: 'Giới tính', value: UserFields.GENDER, type: InputTypeEnum.INPUT_DROPDOWN, options: this.optionGender },
    {label: 'Ngày sinh', value: UserFields.BIRTH_DAY, typeInput: "date" , type: InputTypeEnum.DATE},
