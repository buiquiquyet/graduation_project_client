                ...
                <div className="row d-flex">
                  ...
                  >
                    ...
                    <span style={{ fontSize: "18px", color: "#54595F" }}>
                      Tính năng Sứ giả gây quỹ cho phép người dùng được xác thực
                      trên GiveHope tham gia vào việc truyền thông, vận động gây
                      quỹ cho các Tổ chức tại các Dự án gây quỹ cụ thể{" "}
                  ...
                  >
                    ...
                    <span style={{ fontSize: "18px", color: "#54595F" }}>
                      Bạn có thể ủng hộ các dự án qua 03 bước đơn giản bằng bất
                      cứ tài khoản thanh toán điện tử nào mà mình có tại
                      GiveHope, như: Ví điện tử MOMO và bạn có thể trở thành sứ giả khi quyên góp đủ số tiền đáp ứng.
                    </span>
